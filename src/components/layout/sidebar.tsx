  ...
  return (
    <aside className="flex flex-col w-64 h-screen bg-surface border-r border-border-subtle">
      ...
      <div className="px-4 py-4 border-t border-border-subtle">
        <p className="text-xs text-text-muted">Naval Rapid Capabilities Office</p>
        <p className="text-xs text-text-muted mt-0.5">Foundry-to-Fleet Pipeline</p>
      </div>
    </aside>
  );
}
